...
use super::{mesh_view_types::{
    ClusterLightIndexLists, ClusterOffsetsAndCounts, Globals, Lights, PointLights, View,
}, shadows::{PointShadowTextures, DirectionalShadowTextures}};
...
pub type TextureDepth2dArray =
    Image!(2D, type = f32, sampled = true, depth = true, arrayed = true);
